      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-10 w-full max-w-3xl text-center relative">
        ...
        {status === 'ready' && (
          <div className="w-full flex flex-col gap-4">
            <div
              className="animation-canvas w-full rounded-xl border border-white/10 bg-white/5 p-4 text-left overflow-y-auto max-h-[70vh]"
              data-testid="animation-canvas"
            >
              <pre className="text-xs text-[#c6c6c8] whitespace-pre-wrap break-words">
